...
class DriveReplyMsgModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentInput: "",
  ...
  handleSubmitClick = () => {
    ...
    this.props.handleYourDriveMsgSubmit(this.state.commentInput);
    this.props.hideModal();
  };
        ...
        >
          ...
          <Modal.Body>
            <Form.Group className="mb-3" controlId="formOrderComment">
              <Form.Label>
                <b>Message for {this.props.selectedYourDriveNameDoc.label}</b>
              </Form.Label>
...
export default DriveReplyMsgModal;
